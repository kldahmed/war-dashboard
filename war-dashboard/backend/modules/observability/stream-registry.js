...
const OFFICIAL_STREAM_REGISTRY = [
  ...
  { id: 'alhurra-live', name: 'Alhurra', category: 'news', language: 'ar', provider: 'hls', sourceDomain: 'alhurra.com', officialPageUrl: 'https://www.alhurra.com/', embedUrl: 'https://mbn-ingest-worldsafe.akamaized.net/hls/live/2038900/MBN_Alhurra_Worldsafe_HLS/master.m3u8', externalWatchUrl: 'https://www.alhurra.com/', embedSupported: true, sortOrder: 190, active: true, lastVerifiedAt: LAST_VERIFIED_AT, verificationStatus: 'embed_ok' },
